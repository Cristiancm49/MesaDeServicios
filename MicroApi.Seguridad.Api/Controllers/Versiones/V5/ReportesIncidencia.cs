...
namespace MicroApi.Seguridad.Api.Controllers.Versiones.V5
{
    ...
    [ApiController]
    public class ReportesIncidencia : ControllerBase
    {

        private readonly ModelContextSQL _context;

        public ReportesIncidencia(ModelContextSQL context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> HistoricoIncidencias()
        {
            ...
            {
                return NotFound("No se encontró el historial de incidencias.");
            }
